 ...
 */
package com.bm.fqcomponentsoss.model;

import com.bm.fqcomponentsoss.constant.OssSavePlaceEnum;
...
public class OssFileConfig {
    ...
    /** 用户头像 **/
    interface BIZ_TYPE {
        String EXCEL = "excel"; /** 文档存储 **/
        String IAMGE = "image"; /** 照片存储 **/
        String VIDEO = "video"; /** 视频存储 **/
        String CERT = "cert";  /** 接口参数 **/
    }
    /** 图片类型后缀格式 **/
    public static final Set IMG_SUFFIX = new HashSet(Arrays.asList("jpg", "png", "jpeg", "gif","JPG", "JPEG", "PNG", "GIF"));
    public static final Set VIDEO_SUFFIX = new HashSet(Arrays.asList("wmv", "3gp", "mp4", "flv","asf","avi"));
    ...
    static{
        ALL_BIZ_TYPE_MAP.put(BIZ_TYPE.VIDEO, new OssFileConfig(OssSavePlaceEnum.PUBLIC, VIDEO_SUFFIX, DEFAULT_MAX_SIZE) );
        ALL_BIZ_TYPE_MAP.put(BIZ_TYPE.EXCEL, new OssFileConfig(OssSavePlaceEnum.PUBLIC, IMG_SUFFIX, DEFAULT_MAX_SIZE) );
        ALL_BIZ_TYPE_MAP.put(BIZ_TYPE.IAMGE, new OssFileConfig(OssSavePlaceEnum.PUBLIC, IMG_SUFFIX, DEFAULT_MAX_SIZE) );
