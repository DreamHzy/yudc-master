 ...
 */
package com.bm.fqcomponentsoss.service;

import com.bm.fqcomponentsoss.config.OssYmlConfig;
import com.bm.fqcomponentsoss.constant.OssSavePlaceEnum;
import com.bm.fqcore.service.CoreISysConfigService;
...
public class LocalFileService implements IOssService{
    ...
    @Autowired private CoreISysConfigService coreISysConfigService;
    ...
    public String upload2PreviewUrl(OssSavePlaceEnum ossSavePlaceEnum, MultipartFile multipartFile, String saveDirAndFileName) {
        ...
        return coreISysConfigService.getDBApplicationConfig().getOssPublicSiteUrl() + "/" + saveDirAndFileName;
    }
