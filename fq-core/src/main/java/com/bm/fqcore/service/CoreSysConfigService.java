 ...
 */
package com.bm.fqcore.service;

import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.bm.fqcore.model.DBApplicationConfig;
import com.bm.fqservice.mapper.BSysConfigMapper;
import com.bm.fqservice.model.BSysConfig;
 ...
 */
@Service
public class CoreSysConfigService extends ServiceImpl<BSysConfigMapper, BSysConfig> implements CoreISysConfigService {
    ...
    @Autowired
    private CoreSysConfigService sysConfigService;
    ...
    public JSONObject selectByGroupKey(String groupKey){
        ...
        list(BSysConfig.gw().select(BSysConfig::getConfigKey, BSysConfig::getConfigVal).eq(BSysConfig::getGroupKey, groupKey))
    ...
    public int updateByConfigKey(Map<String, String> updateMap) {
        ...
        for(String k : set) {
            BSysConfig sysConfig = new BSysConfig();
