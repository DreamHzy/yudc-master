...
import com.bm.fqcore.utils.SpringBeansUtil;
...
public class JeeAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        AppUserDetails jeeUserDetails = commonFilter(request);
    ...
    private AppUserDetails commonFilter(HttpServletRequest request){
        ...
        //根据用户名查找数据库
        AppUserDetails jwtBaseUser = RedisUtil.getObject(jwtPayload.getCacheKey(), AppUserDetails.class);
        if(jwtBaseUser == null){
