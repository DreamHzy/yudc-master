 ...
 */
package com.bm.fqmerchant.aop;

import com.alibaba.fastjson.JSONObject;
import com.bm.fqcore.aop.MethodLog;
import com.bm.fqcore.beans.RequestKitBean;
...
import com.bm.fqservice.model.BSysLog;
import com.bm.fqservice.service.IBSysLogService;
...
public class MethodLogAop {
    ...
    @Autowired private IBSysLogService sysLogService;
     ...
     * 切点
     */
    @Pointcut("@annotation(com.bm.fqcore.aop.MethodLog)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        final BSysLog sysLog = new BSysLog();
     ...
     */
    private void setBaseLogInfo(JoinPoint joinPoint, BSysLog sysLog, JeeUserDetails userDetails) throws Exception {
