 ...
 */
package com.bm.fqmerchant.ctrl.anon;
...
public class AuthController extends CommonCtrl {
    ...
    public ApiRes validate() throws BizException {
        String account ="13093783517";  //用户名 i account, 已做base64处理
        String ipassport = "jeepay666";    //密码 i passport,  已做base64处理
//        String vercode = "";    //验证码 vercode,  已做base64处理
